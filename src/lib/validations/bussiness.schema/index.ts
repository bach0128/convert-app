...
export const createBussinessSchema = z.object({
  tax_code: z.string({ message: 'Vui lòng điền mã số thuế' }),
  name: z.string({ message: 'Vui lòng điền tên hộ kinh doanh' }),
  owner: z.string({ message: 'Vui lòng điền tên người đại diện' }),
  address: z.string({ message: 'Vui lòng điền địa chỉ kinh doanh' }),
  phone: z
    .string()
  ...
  taxPaymentMethod: z.coerce.number({
    message: 'Vui lòng chọn hình thức nộp thuế',
  }),
  bussinessType: z.coerce.number({
